...
import com.unicesumar.repository.NotaFiscalRepository;
...
public class Main {
    public static void main(String[] args) {
        ...
        NotaFiscalRepository listaDeNotas = null;
        ...
        List<Double> carrinhoPreco = new ArrayList<Double>();
        String nominho;
        ...
        try {
            ...
            if (conn != null) {
                ...
                listaDeNotas = new NotaFiscalRepository(conn);
            } else {
        ...
        listaDeNotas.resetarTabelaNotasFiscais();
                        ...
                        do {
                            ...
                            if (opcao == 1) {
                                ...
                                if (ProductOptional.isPresent()) {
                                    ...
                                    carrinhoPreco.add(ProductOptional.get().getPrice());
                        ...
                        if (valor > 0){
                            ...
                            if (metodoPagamento < 4){
                                ...
                                if (metodoPagamento == 1){
                                    ...
                                    metodoPagamentoStr = "Boleto";
                                    option = 6;
                                } else {
                                    System.out.print("Cartão de crédito \n");
                                    metodoPagamentoStr = "Cartão de Crédito";
                                    option = 6;
                                }
                                NotaFiscal notaFiscal = new NotaFiscal(nominho, String.join(", ", carrinho), valor, metodoPagamentoStr);
                                NotaFiscalRepository notaFiscalRepository = new NotaFiscalRepository(conn);
                                ...
                                while (iterator.hasNext()) {
                                    ...
                                    System.out.println(" R$"+carrinhoPreco.get(x));
                                    x+=1;
                                }
                                System.out.println("\nValor Total: R$" + valor);
                                System.out.println("\nMétodo de Pagamento: " + metodoPagamentoStr);
